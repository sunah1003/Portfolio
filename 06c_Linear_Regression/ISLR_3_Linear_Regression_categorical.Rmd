...
lm.fit<-lm(Sales~ShelveLoc+Income , data=Carseats) # y: Sales(carseat sales), x: ShelveLoc(quality of the shelving location: Bad/Medium/Good), Income level from the database Carseats 
